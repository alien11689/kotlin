...
public inline operator fun <T> Sequence<T>.contains(element: T): Boolean {
...
@kotlin.internal.LowPriorityInOverloadResolution
@Suppress("NOTHING_TO_INLINE")
public inline fun <T> Sequence<T>.indexOf(element: T): Int {
...
@kotlin.internal.LowPriorityInOverloadResolution
@Suppress("NOTHING_TO_INLINE")
public inline fun <T> Sequence<T>.lastIndexOf(element: T): Int {
    return indexOfRaw(element)
}
