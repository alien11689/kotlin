...
private val unaryOperations: HashMap<UnaryOperationKey<*>, Pair<Function1<Any?, Any>, Function1<Long, Long>>>
        ...
        unaryOperation(BYTE, "minus", { a -> a.<!DEPRECATION!>minus<!>() }, { a -> a.<!DEPRECATION!>minus<!>() }),
        unaryOperation(BYTE, "minus", { a -> a.<!DEPRECATION!>minus<!>() }, { a -> a.<!DEPRECATION!>minus<!>() }),
        unaryOperation(BYTE, "toChar", { a -> a.toChar() }, emptyUnaryFun),
        unaryOperation(BYTE, "toLong", { a -> a.toLong() }, emptyUnaryFun),
        unaryOperation(BYTE, "plus", { a -> a.<!DEPRECATION!>plus<!>() }, emptyUnaryFun),
        ...
        unaryOperation(DOUBLE, "minus", { a -> a.<!DEPRECATION!>minus<!>() }, emptyUnaryFun),
        unaryOperation(DOUBLE, "toChar", { a -> a.toChar() }, emptyUnaryFun),
        unaryOperation(DOUBLE, "toLong", { a -> a.toLong() }, emptyUnaryFun),
        unaryOperation(DOUBLE, "plus", { a -> a.<!DEPRECATION!>plus<!>() }, emptyUnaryFun),
        ...
        unaryOperation(FLOAT, "minus", { a -> a.<!DEPRECATION!>minus<!>() }, emptyUnaryFun),
        unaryOperation(FLOAT, "toChar", { a -> a.toChar() }, emptyUnaryFun),
        unaryOperation(FLOAT, "toLong", { a -> a.toLong() }, emptyUnaryFun),
        unaryOperation(FLOAT, "plus", { a -> a.<!DEPRECATION!>plus<!>() }, emptyUnaryFun),
        ...
        unaryOperation(INT, "plus", { a -> a.<!DEPRECATION!>plus<!>() }, emptyUnaryFun),
        ...
        unaryOperation(INT, "minus", { a -> a.<!DEPRECATION!>minus<!>() }, { a -> a.<!DEPRECATION!>minus<!>() }),
        ...
        unaryOperation(LONG, "plus", { a -> a.<!DEPRECATION!>plus<!>() }, emptyUnaryFun),
        ...
        unaryOperation(LONG, "minus", { a -> a.<!DEPRECATION!>minus<!>() }, { a -> a.<!DEPRECATION!>minus<!>() }),
        ...
        unaryOperation(SHORT, "minus", { a -> a.<!DEPRECATION!>minus<!>() }, { a -> a.<!DEPRECATION!>minus<!>() }),
        unaryOperation(SHORT, "toChar", { a -> a.toChar() }, emptyUnaryFun),
        unaryOperation(SHORT, "toLong", { a -> a.toLong() }, emptyUnaryFun),
        unaryOperation(SHORT, "plus", { a -> a.<!DEPRECATION!>plus<!>() }, emptyUnaryFun),
