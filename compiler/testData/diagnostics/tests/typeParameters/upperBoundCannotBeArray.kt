...
fun <S, T : S, <!UPPER_BOUND_CANNOT_BE_ARRAY!>A<!>> f3() where A : Array<out S>, A : <!BOUND_APPEARS_TWICE!>Array<out T><!> {}
...
interface C3<S, T : S, <!UPPER_BOUND_CANNOT_BE_ARRAY!>A<!>> where A : Array<out S>, A : <!BOUND_APPEARS_TWICE!>Array<out T><!>
