...
fun testImplicitCoercion() {
    ...
    var <!UNUSED_VARIABLE!>iff<!> = <!IMPLICIT_CAST_TO_UNIT_OR_ANY, INVALID_IF_AS_EXPRESSION!>if (true) {
        <!UNUSED_VALUE!>z =<!> 34
    }<!>
    val <!UNUSED_VARIABLE!>g<!> = <!IMPLICIT_CAST_TO_UNIT_OR_ANY, INVALID_IF_AS_EXPRESSION!>if (true) 4<!>
    val <!UNUSED_VARIABLE!>h<!> = <!IMPLICIT_CAST_TO_UNIT_OR_ANY, INVALID_IF_AS_EXPRESSION!>if (false) 4 else {}<!>
