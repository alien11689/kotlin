...
public class QuickFixMultiFileTestGenerated extends AbstractQuickFixMultiFileTest {
    ...
    public static class AutoImports extends AbstractQuickFixMultiFileTest {
        ...
        @TestMetadata("multiDeclarationExtensionDifferentPackages.test")
        public void testMultiDeclarationExtensionDifferentPackages() throws Exception {
            String fileName = JetTestUtils.navigationMetadata("idea/testData/quickfix/autoImports/multiDeclarationExtensionDifferentPackages.test");
            doTestWithExtraFile(fileName);
        }
        ...
        @TestMetadata("operatorAssignPlusTwoVariants.test")
        public void testOperatorAssignPlusTwoVariants() throws Exception {
            String fileName = JetTestUtils.navigationMetadata("idea/testData/quickfix/autoImports/operatorAssignPlusTwoVariants.test");
            doTestWithExtraFile(fileName);
        }
    ...
    public static class Migration extends AbstractQuickFixMultiFileTest {
        ...
        public static class MigrateJavaAnnotationMethodCall extends AbstractQuickFixMultiFileTest {
            public void testAllFilesPresentInMigrateJavaAnnotationMethodCall() throws Exception {
                JetTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("idea/testData/quickfix/migration/migrateJavaAnnotationMethodCall"), Pattern.compile("^(\\w+)\\.((before\\.Main\\.\\w+)|(test))$"), true);
            }
