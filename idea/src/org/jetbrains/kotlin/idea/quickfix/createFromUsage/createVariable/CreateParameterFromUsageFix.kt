...
public open class CreateParameterFromUsageFix<E : JetElement>(
    ...
    companion object {
        public fun <E : JetElement> createFixForPrimaryConstructorPropertyParameter(
                element: E,
                info: PropertyInfo
            ...
            if (receiverTypeCandidate != null) {
                ...
                if (element !is JetSimpleNameExpression) return null

                val classOrObject = element.getStrictParentOfType<JetClassOrObject>() ?: return null
            ...
            val receiverClass = receiverClassDescriptor.source.getPsi() as? JetClass ?: return null
